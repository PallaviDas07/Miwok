...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numberlist.add(new Word("red", "weṭeṭṭi", R.drawable.color_red, R.raw.color_red));
        numberlist.add(new Word("green", "chokokki", R.drawable.color_green, R.raw.color_green));
        numberlist.add(new Word("brown", "ṭakaakki", R.drawable.color_brown, R.raw.color_brown));
        numberlist.add(new Word("gray", "ṭopoppi", R.drawable.color_gray, R.raw.color_gray));
